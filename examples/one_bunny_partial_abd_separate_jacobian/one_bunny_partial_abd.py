...
s0.addEnergy(snh_energy, projection_method = 2, separate_hessian_jacobian = True)
...
s0.addEnergy(pp_energy, dynamic_instances = True, projection_method = 2, separate_hessian_jacobian = True)
s0.addEnergy(pe_energy, dynamic_instances = True, projection_method = 2, separate_hessian_jacobian = True)
s0.addEnergy(pt_energy, dynamic_instances = True, projection_method = 2, separate_hessian_jacobian = True)
s0.addEnergy(ee_energy, dynamic_instances = True, projection_method = 2, separate_hessian_jacobian = True)
