...
bunny.addPrimitive("vertex_soft", numInstances = position.shape[0] // 2)
bunny.addPrimitive("vertex_rigid", numInstances = position.shape[0] - position.shape[0] // 2)

bunny.addPrimitiveUnion("vertex", [bunny.vertex_soft, bunny.vertex_rigid])
...
##################################################
bunny.vertex_soft.addAttribute("rest_position", rows = 3, cols = 1,)
bunny.vertex_soft["rest_position"].updateValue(position[:position.shape[0] // 2, :])
bunny.vertex_soft.addAttribute("current_position", rows = 3, cols = 1)
bunny.vertex_soft["current_position"].updateValue(moved_position[:position.shape[0] // 2, :])
bunny.vertex_soft.addAttribute("rotated_position", computed_attribute = (rot * (bunny.vertex_soft["current_position"] + translation)))

bunny.vertex_rigid.addAttribute("rest_position", rows = 3, cols = 1,)
bunny.vertex_rigid["rest_position"].updateValue(position[position.shape[0] // 2:, :])
bunny.vertex_rigid.addAttribute("current_position", rows = 3, cols = 1)
bunny.vertex_rigid["current_position"].updateValue(moved_position[position.shape[0] // 2:, :])
bunny.vertex_rigid.addAttribute("rotated_position", computed_attribute = (rot * (bunny.vertex_rigid["current_position"] + translation)))

bunny.vertex.addAttribute("rest_position")
bunny.vertex.addAttribute("current_position")
bunny.vertex.addAttribute("rotated_position")
